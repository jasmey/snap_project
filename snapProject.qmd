...
MSFF_data <- read.csv("metadata_science_fiction_fantasy.csv")
MPF_data <- read.csv("metadata_parenting_families.csv")
MCFW_data <- read.csv("metadata_cooking_food_wine.csv")
